...
swat_normal = table("main.data_infra_service_health.swat_normal_v1").toPandas()
swat_normal.shape

# COMMAND ----------

swat_attack = table("main.data_infra_service_health.swat_attack_v0").toPandas()
swat_attack.shape

# COMMAND ----------

normal, attack = min_max_scale(swat_normal, swat_attack)
...
with open("/Volumes/users/juanyan_li/ransynccoder_benchmark/swat_resample_1s_inference.pkl", "wb") as f:
    import cloudpickle
